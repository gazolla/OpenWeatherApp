...
struct Appearences{
    let appearences:[String:WeatherAppearence] = [
        ...
        "01n": WeatherAppearence(iconName: "moon.stars.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "02n": WeatherAppearence(iconName: "cloud.moon.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "03n": WeatherAppearence(iconName: "cloud.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "04n": WeatherAppearence(iconName: "smoke.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "09n": WeatherAppearence(iconName: "cloud.rain.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "10n": WeatherAppearence(iconName: "cloud.moon.rain.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "11n": WeatherAppearence(iconName: "cloud.bolt.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "13n": WeatherAppearence(iconName: "snowflake", background: Gradient(colors:[Color(#colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))])),
        "50n": WeatherAppearence(iconName: "sun.max.fill", background: Gradient(colors:[Color(#colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1)), Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))]))
    ]
}
